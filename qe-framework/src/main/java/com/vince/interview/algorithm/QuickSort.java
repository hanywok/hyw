...
public class QuickSort {
    ...
    public static void quickSortMe(int arr[], int left, int right){
        int tmpLeft=left;
        int tmpRight=right;
        int temp=0;
        if(tmpLeft<=tmpRight){
           ...
           while(tmpLeft!=tmpRight) {
               ...
               while(tmpRight>tmpLeft&&arr[tmpRight]>=temp)
                   right--;
               arr[tmpLeft]=arr[tmpRight];
               while(tmpLeft<tmpRight&&arr[tmpLeft]<=temp)
                   left--;
               arr[tmpRight]=arr[tmpLeft];
           }
           arr[tmpRight]=temp;
           quickSortMe(arr,left,tmpLeft-1);
           quickSortMe(arr,tmpRight+1,right);
        }
